...
hold on
fig_sim = scatter(phantom_index_x, phantom_index_y,'b');
set(fig_sim,'SizeData', 30); % size of dots
% set(fig_sim,'MarkerFacecolor','flat'); % appearance of dots
